...
if("TRUE" STREQUAL "TRUE")
  ...
  set(hector_trajectory_server_DEVEL_PREFIX /root/catkin_ws/devel/.private/hector_trajectory_server)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hector_trajectory_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/hector_slam/hector_trajectory_server/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/.private/hector_trajectory_server/lib;/root/catkin_ws/devel/lib;/opt/ros/noetic/lib)
